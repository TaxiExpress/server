...
def loadData(request):
    ...
    car.save()
    dr = Driver(email="conductor@gmail.com", password="11111111", phone="+34656111112", first_name="Conductor", last_name="DePrimera", city=ci, validationCode=123456, positiveVotes=10, negativeVotes=3, car=car, geom=Point(43.2618425, -2.9327811))
    dr.save()
    ...
    car.save()
    dr2 = Driver(email="conductor2@gmail.com", password="11111111", phone="+34656111113", first_name="Conductor", last_name="DeSegunda", city=ci, validationCode=123456, positiveVotes=2, negativeVotes=7, car=car, geom=Point(43.264116, -2.9237662))
    dr2.save()
    cu = Customer(email="gorka_12@hotmail.com", password="11111111", phone="+34656111111", first_name="Pepito", last_name="Palotes", city=ci, validationCode=123456, lastUpdate=datetime.strptime('1980-01-01 00:00:01','%Y-%m-%d %H:%M:%S'))
    cu.save()
    cu.favlist.add(dr)
    cu.favlist.add(dr2)

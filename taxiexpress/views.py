...
def getSelectedTaxi(request):
    if 'sessionID' in request.POST:
        ...
        post_data = {"pushId": driver.pushID , "title" : "Un cliente solicita sus servicios" , "message" : 802 , "origin": request.POST['origin'], "startpoint": "niputaidea", "travelID": travel.id, "email": customer.email, "phone": customer.phone} 
        try:

...
urlpatterns = patterns('',
    ...
    url(r'^client/validate', 'taxiexpress.views.recovervalidationcodecustomer', name='recoverValidationCodeCustomer'),
    url(r'^client/validate', 'taxiexpress.views.recovervalidationcodedriver', name='recoverValidationCodeDriver'),

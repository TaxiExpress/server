...
urlpatterns = patterns('',
    ...
    url(r'^client/getcustomeremail', 'taxiexpress.views.recoverEmail', name='recoverEmail'),
    ...
    url(r'^client/canceltravel', 'taxiexpress.views.cancelTravelCustomer', name='cancelTravelCustomer'),
    ...
    url(r'^driver/canceltravel', 'taxiexpress.views.cancelTravelDriver', name='cancelTravelDriver'),
    ...
    url(r'^driver/votecustomer', 'taxiexpress.views.voteCustomer', name='voteCustomer'),
    url(r'^driver/getcustomerdata', 'taxiexpress.views.getCustomerPublicData', name='getCustomerPublicData'),
    ...
    url(r'^invoicing', 'taxiexpress.views.invoicing', name='invoicing'),
    ...
    url(r'^mantclient_travels', 'web.views.mantclient_travels', name='mantclient_travels'),
    ...
    url(r'^mantdriver_travels', 'web.views.mantdriver_travels', name='mantdriver_travels'),
    ...
    url(r'^statistics/gettravelsbylastyear', 'web.views.getTravelsByLastYear', name='getTravelsByLastYear'),
    url(r'^statistics/gettravelsbylastmonth', 'web.views.getTravelsByLastMonth', name='getTravelsByLastMonth'),
